...
public void velocidadDeCarga(){
    ...
    {
      for (long j=0; j<1000000; ++j)//modifica el numero segun la velocidad que quieras
      {
        String poop = " " + (j + i);
      }
     setProgreso("" + i, i);  // si quieres que muestre los numeros y un mensaje
     //setProgreso(i);        //si quieres que muestre nada, solo la barra
   }
    dispose();}
